...
function Paintings({ changeIndexPaintings, indexPaintings, setShowContent, showContent, page }) {
                    ...
                    >
                        ...
                        {page === 'pinturas' ? (
                            ...
                            <BoxTexts gap='0.8rem'>
                                ...
                                <InitionButton text=' Trabalhos' link='trabalhos' />
                                <InitionButton text=' as Pinturas' link='pinturas' />
                            </BoxTexts>
                        )}
                    </BoxContent>
                    {page === 'pinturas' && (
